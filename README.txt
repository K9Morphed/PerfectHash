...
1) testData1.txt && testOp1.txt
2) testData2.txt && testOp2.txt

NOTE: This program was created as part of a university assignment. The implementation may not be perfect, however testing has proven that it works with the majority of inputs.